...
const SCHEMA = {
  ...
  projects: ['id', 'title', 'client_id', 'client_name', 'type', 'status', 'current_stage', 'stage_completion', 'total_fee', 'start_date', 'end_date', 'description', 'notes', 'created_at'],
  ...
  invoices: ['id', 'invoice_number', 'project_id', 'project_title', 'client_id', 'client_name', 'client_email', 'stage', 'stage_description', 'amount', 'due_date', 'status', 'paid_at', 'notes', 'created_at'],
